...
public class PreBackpackSaleEvent extends Event implements Cancellable {
    ...
    public PreBackpackSaleEvent(Backpack backpack, String group, Pet pet, int amountToSell, SellMethodType sellMethod) {
